...
-- Executar este script via Supabase Dashboard → SQL Editor
-- ============================================================================
...
-- Tabela: funcionarios_funcionario
...
-- Execute this query to verify all tables were created:
